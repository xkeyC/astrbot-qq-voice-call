...
bridge_dir=${MAIBOT_QQ_CALL_BRIDGE_DIR:-$default_bridge_dir}
runtime_dir="$bridge_dir/runtime"
logs_dir="$bridge_dir/logs"
token_file=${MAIBOT_QQ_CALL_BRIDGE_TOKEN_FILE:-$runtime_dir/control.token}
...
qq_dir=${MAIBOT_QQ_CALL_QQ_DIR:-$(read_saved_path qq-dir)}
napcat_dir=${MAIBOT_QQ_CALL_NAPCAT_DIR:-$(read_saved_path napcat-dir)}
avsdk_path=${MAIBOT_QQ_CALL_AVSDK_PATH:-${qq_dir:+$qq_dir/resources/app/avsdk/libAVSDKPlugin.so}}
